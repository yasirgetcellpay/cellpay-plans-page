...
const ATT = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans antialiased">
      ...
      {/* Form Card */}
      <div className="max-w-[600px] mx-auto px-4 pt-6 pb-8 sm:pb-12">
        <div className="bg-card rounded-xl shadow-lg border border-border p-5 sm:p-8">
          ...
          <div className="relative mb-5 sm:mb-6">
            ...
            <input
              ...
              className="w-full h-10 sm:h-12 pl-10 sm:pl-11 pr-4 rounded-lg border border-input bg-background text-sm sm:text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[hsl(196,100%,44%)] focus:border-transparent"
            />
          </div>
          ...
          <div className="relative mb-4 sm:mb-5">
            ...
            <input
              ...
              placeholder="Enter an amount between 5 - 300"
              className="w-full h-10 sm:h-12 pl-10 sm:pl-11 pr-4 rounded-lg border border-input bg-background text-sm sm:text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[hsl(196,100%,44%)] focus:border-transparent"
            />
          </div>

          {/* Quick-select buttons */}
          <div className="grid grid-cols-5 gap-2 mb-5 sm:mb-6">
            {quickAmounts.map((amt) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-lg border-2 py-2 text-xs sm:text-sm font-bold transition-all active:scale-[0.96] ${
                    isSelected
                      ? "border-[hsl(196,100%,44%)] bg-[hsl(196,100%,44%)] text-primary-foreground"
                      : "border-border bg-muted text-foreground hover:border-[hsl(196,100%,44%)]"
                  }`}
                >
                  ${amt}
                </button>
          ...
          <label className="flex items-start gap-2 mb-3 cursor-pointer">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-input accent-[hsl(196,100%,44%)]"
            />
          ...
          <label className="flex items-start gap-2 mb-6 cursor-pointer">
            ...
            />
            <span className="text-[11px] sm:text-xs text-muted-foreground leading-relaxed">
              Agree with AT&amp;T Product Policies and Sales.{" "}
              <a href="https://www.att.com/legal/terms.attWebsiteTermsOfUse.html" className="text-[hsl(196,100%,44%)] underline font-semibold">
                View More
              </a>
            </span>
          </label>
          ...
          <div className="flex justify-center">
            <button
              type="button"
              disabled={!isValid}
              className="h-[48px] sm:h-[52px] px-12 sm:px-16 rounded-lg bg-[hsl(196,100%,44%)] hover:bg-[hsl(196,100%,38%)] disabled:opacity-50 disabled:cursor-not-allowed text-primary-foreground font-bold text-base sm:text-lg transition-colors active:scale-[0.97]"
            >
              PAY NOW
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-muted pt-6 text-center">
            ...
            <p className="text-[10px] leading-relaxed max-w-4xl mx-auto opacity-50 mt-3">
              AT&amp;T® is a registered trademark of AT&amp;T Intellectual Property. All carrier names and trademarks are property of their respective owners.
            </p>
          </div>
        </div>
      </footer>
