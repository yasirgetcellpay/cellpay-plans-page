          ...
          {plans.map((plan, i) => {
            ...
            return (
              <button key={i} type="button" onClick={() => setSelectedPlan(i)}
                className={`rounded-lg border-2 text-left overflow-hidden transition-all active:scale-[0.97] ${isSelected ? "border-[hsl(0,70%,50%)]" : "border-border hover:border-[hsl(0,70%,50%)]/50"}`}>
