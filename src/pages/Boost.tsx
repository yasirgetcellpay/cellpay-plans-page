...
const Boost = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans antialiased">
      ...
      <div className="max-w-[600px] mx-auto px-4 pt-6 pb-8 sm:pb-12">
        <div className="bg-card rounded-xl shadow-lg border border-border p-5 sm:p-8">
          ...
          <label className="block text-xs sm:text-sm font-bold text-foreground mb-1.5 sm:mb-2">
            Enter Your Boost Mobile Phone Number
          </label>
          <div className="relative mb-5 sm:mb-6">
            ...
            <input
              ...
              className="w-full h-10 sm:h-12 pl-10 sm:pl-11 pr-4 rounded-lg border border-input bg-background text-sm sm:text-base text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[hsl(27,100%,50%)] focus:border-transparent"
            />
          </div>
          ...
          <label className="flex items-start gap-2 mb-3 cursor-pointer">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-input accent-[hsl(27,100%,50%)]"
            />
          ...
          <label className="flex items-start gap-2 mb-6 cursor-pointer">
            ...
            />
            <span className="text-[11px] sm:text-xs text-muted-foreground leading-relaxed">
              Agree with Boost Mobile Product Policies and Sales.{" "}
              <a href="https://www.boostmobile.com/about/legal/terms-conditions" className="text-[hsl(27,100%,50%)] underline font-semibold">
                View More
              </a>
            </span>
          </label>
          ...
          <div className="flex justify-center">
            <button
              type="button"
              disabled={!isValid}
              className="h-[48px] sm:h-[52px] px-12 sm:px-16 rounded-lg bg-[hsl(27,100%,50%)] hover:bg-[hsl(27,100%,44%)] disabled:opacity-50 disabled:cursor-not-allowed text-primary-foreground font-bold text-base sm:text-lg transition-colors active:scale-[0.97]"
            >
              PAY NOW
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-muted pt-6 text-center">
            ...
            <p className="text-[10px] leading-relaxed max-w-4xl mx-auto opacity-50 mt-3">
              Boost Mobile® is a registered trademark of DISH Wireless L.L.C. All carrier names and trademarks are property of their respective owners.
            </p>
          </div>
        </div>
      </footer>
      ...
      {/* Legal Bar */}
      <div className="bg-[hsl(27,100%,50%)] text-primary-foreground py-3 text-[10px] md:text-xs">
