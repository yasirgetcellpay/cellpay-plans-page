    ...
    <div className="min-h-screen bg-background font-sans antialiased">
      ...
      <div className="max-w-[280px] sm:max-w-[420px] mx-auto px-4 pt-4 pb-4 sm:pt-6 sm:pb-6">
        <div className="bg-card rounded-xl shadow-lg border border-border p-4 sm:p-6 text-center">
          ...
          {amountNum >= 10 && amountNum <= 500 && (
            <button type="button" onClick={() => {
              if (isValid) {
                navigate("/checkout", { state: { phone, amount, carrierSlug: "tmobile", carrierName: "T-Mobile", brandColor: BRAND } });
              } else {
      ...
      <PaymentBar />
      <CarrierFooter brandColor={BRAND} carrierName="T-Mobile" />
    </div>
  );
};
