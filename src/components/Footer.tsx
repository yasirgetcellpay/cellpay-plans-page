      ...
      <footer className="bg-cellpay-dark text-muted-foreground py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                ...
                <li><button onClick={handleLogin} className="hover:text-primary-foreground">Sign Up</button></li>
          ...
          <div className="border-t border-muted pt-8 text-center">
            <p className="text-xs mb-4">© 2026 CellPay. All rights reserved. | Privacy Policy | Terms &amp; Conditions | Contact Us</p>
